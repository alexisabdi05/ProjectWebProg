...
<body>
    ...
    <div class="sec3">
        ...
        <h3>Unleash your creativity and master design with our best courses, where you'll discover how simple it is with
            Colorverse.</h3>
    </div>
            ...
            <div class="grid grid-cols-3 gap-9">
                <div class="c41_base">
                    <div class="c41">
                        ...
                        <div class="c41_back text-lg">
                            <h1>100% Free to Learn Illustrator</h1>
                        </div>
                    </div>
                </div>
                <div class="c42_base">
                    <div class="c42">
                        ...
                        <div class="c42_back text-lg">
                            <h1>Become a canva master for free</h1>
                        </div>
                    </div>
                </div>
                <div class="c43_base">
                    <div class="c43">
                        ...
                        <div class="c43_back text-lg">
                            <h1>Learn photoshop from scratch</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="sec5">
        <div class="grid grid-cols-3 gap-12">
            <div class="c51">
                ...
                <p>“Colorverse has been an invaluable resource in my journey as a freelance graphic designer. Their
                    exceptional selection of free online courses has not only expanded my skillset but also enhanced my
                    marketability in the industry.”</p>
            </div>
            <div class="c51">
                <div class="c51_pic">
                ...
                <p>“I am incredibly grateful for Colorverse, the ultimate destination for free online design courses.
                    Thanks to Colorverse, I now have the skills and confidence to bring my design ideas to life.”</p>
            </div>
            <div class="c51">
                <div class="c51_pic">
                ...
                <h3>Lisa</h3>
                <h4>Student</h4>
                <p>“As a student pursuing a career in design, Colorverse has been an absolute blessing. Their website
                    offers a wide range of free online courses that have allowed me to explore different areas of design
                    and discover my true passion.”</p>
            </div>
        </div>
    </div>
